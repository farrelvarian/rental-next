...
import { testimonial, star, circle, plus,next,previous } from "../../../public/assets";
...
const home = () => {
  ...
  return (
    <HomeUser>
     ...
     <CardSection heading="Popular in Town" anchor="popular-in-town"/>
          ...
          <div className="right">
            <div className="card-profile">
              ...
              <div className="icon-illustration plus">
                <Image src={plus} alt="icon" layout="fill" />
              </div>
